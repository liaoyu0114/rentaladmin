        ...
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                ...
                <div class="header-button">
                    <div v-if="scope.row.lease_type === 1">
            ...
            <el-row :gutter="10">
                <el-col :span="6" class="lease-user">
                    ...
                    <div class="lease-user-name">{{scope.row.tenant.tenant_nickname}}</div>
                    <div class="lease-user-contact">{{scope.row.tenant.tenant_contact}}</div>
                </el-col>
                <el-col :span="6" class="lease-house-pic">
                    <el-image
                        ...
                        :preview-src-list="scope.row.house.housingresources_pic"
                    ></el-image>
                </el-col>
                <el-col :span="12" class="lease-houser">
                    <div class="lease-house-name">
                        <span>房屋名称：{{scope.row.house.housingresources_name}}</span>
                        <br />
                        <span>月租金：{{scope.row.house.housingresources_price}}</span>
                        <br />
                        <span>地址：{{scope.row.house.housingresources_address}}</span>
                        <br />
                        <span>押金类型：{{scope.row.house.housingresources_renttype}}</span>
                        <br />
